...
const progBarUp = () =>
{
  if ($('#AnimalsandTrainers').find('input.clicked').length === 1)
  {
    perc += 25;
    console.log(perc);
  ...
  if ($('#Actors').find('input.clicked').length === 1)
  {
    perc += 25;
    console.log(perc);
    $('#progress').width(`${perc}%`).text(perc);
  ...
  if (($('#Locations').find('input.clicked').length === 1))
  {
    perc += 25;
    console.log(perc);
    $('#progress').width(`${perc}%`).text(perc);
  ...
  if (($('#SpecialEffects').find('input.clicked').length === 1))
  {
    perc += 25;
    console.log(perc);
    $('#progress').width(`${perc}%`).text(perc);
